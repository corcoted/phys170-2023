...
::: {.column width="50%"}
![Perceived intensity vs. frequency (see also, textbook Figure 10-1)](figs/lecture-08/w1041.jpg){width="100%"}
:::
:::
...
| Musical dynamic Level | Sound subjective loudness | Sound loudness | Sound intensity level | Sound intensity |
|--------------|--------------|--------------|--------------|----------------|
