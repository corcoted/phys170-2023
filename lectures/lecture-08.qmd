...
So, the dynamic range of *intensity* for human hearing is about 10^12^.  By comparison, a 16-bit ADC on a digital recording deck has a dynamic range of 2^16^ &approx; 65,000.

The dynamic range of *frequency* for human hearing is about 20,000 Hz/20 Hz = 1,000.
...
The reference value is usually something agreed upon by the community.
