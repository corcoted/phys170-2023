...
One of the earliest methods was the *Pythagorean* scale.  This is made by chosing a starting pitch (e.g. A~4~\ =\ 440\ Hz) and going up or down in perfect fifths (3/2 ratio = 702 cents), then dropping or raising by octaves as needed to build the A~4~ major scale.  This automatically includes the perfect fourths as well.
