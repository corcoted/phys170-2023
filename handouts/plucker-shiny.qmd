...
duration = 0.2  # duration of tone in seconds
...
def server(input, output, session):
    ...
    def gen_wavefile():
        ...
        with open(wavefile, "rb") as f:
            wave64=base64.b64encode(f.read()).decode("ascii")
        return wave64
    ...
    @render.ui
    def audio_w():
        return ui.HTML(f'<audio controls><source src="data:audio/wav;base64,{gen_wavefile()}" type="audio/wav" ></audio>')
