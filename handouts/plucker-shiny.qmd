...
def server(input, output, session):
    ...
    @render_widget
    def audio_w():
        with open(gen_wavefile(),'rb') as f:
            audio_widget = ipyw.Audio.from_file(f)
        return audio_widget
        #return ipyw.HTML("<p>Testing</p>")

    #@output
    #@render.ui
    #def audio_w():
    #    return ui.HTML(f'<audio controls><source src="{gen_wavefile()}" type="audio/wav" ></audio>')
